...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comentarista: @comentario.comentarista, cuerpo: @comentario.cuerpo, emisora_id: @comentario.emisora_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { comentarista: @comentario.comentarista, cuerpo: @comentario.cuerpo, emisora_id: @comentario.emisora_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
